...
class utils():
    ...
    def similarity_by_class(self, multi_topics_stats_df=None,
        ...
        if len(pairs) == 0:
            ...
            print(f'No topic set found (max r-squared & slope error independently: {max(list_rs):.3f}, {max(list_err):.3f}.')
            return None
